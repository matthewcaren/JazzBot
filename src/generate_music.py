...
chunk_length = 1000 # how many chunks are being generated (increase for longer generation)
...
resolution = 1440 # change to read from file!!!
...
maxlen = 15 # number of notes back the LSTM looks at to inform generation
...
for i in range(chunk_length):
    ...
    for t, chunk in enumerate(part_of_song):
        x[0, t, chunk_indices[chunk]] = 1. # append 12x1 4-hot vector for harmony
